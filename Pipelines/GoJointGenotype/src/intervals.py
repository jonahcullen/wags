...
checkpoint generate_intervals:
    ...
    output:
        ivals     = directory("{bucket}/wgs/pipeline/{ref}/{date}/intervals/import/"),
        lengths   = "{bucket}/wgs/pipeline/{ref}/{date}/intervals/collapsed_lengths.csv",
        ivals_all = "{bucket}/wgs/pipeline/{ref}/{date}/intervals/wags_intervals.list",
    params:
        base      = "{bucket}/wgs/pipeline/{ref}/{date}/intervals/import",
       #ivals_all = f"{config['bucket']}/wgs/friedlab/pipeline/{config['ref']}/{config['date']}/intervals/wags_intervals.list",
    run:

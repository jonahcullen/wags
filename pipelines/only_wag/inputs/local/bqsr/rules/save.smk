...
rule upload_pipe_and_logs:
    ...
    output:
        touch("{bucket}/wgs/{breed}/{sample_name}/{ref}/upload_pipe.done")
    params:
        alias   = config['alias'],
    ...
    run:
        ...
        shell('''
            ...
            mc cp {wildcards.ref}_only_wag.yaml {wildcards.breed}_{wildcards.sample_name}.only_wag.{params.profile} only_wag.smk input.tsv \

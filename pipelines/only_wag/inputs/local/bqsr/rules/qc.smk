...
rule bqsr_analyze_covariates:
    ...
    output:
        ac_pdf = "{bucket}/wgs/{breed}/{sample_name}/{ref}/qc/{sample_name}.{ref}.analyze_cov.pdf",
        ac_csv = "{bucket}/wgs/{breed}/{sample_name}/{ref}/qc/{sample_name}.{ref}.analyze_cov.csv",
    benchmark:
...
rule collect_metrics_on_vcf:
    ...
    output:
        detail_metrics  = "{bucket}/wgs/{breed}/{sample_name}/{ref}/money/final_gather/{breed}_{sample_name}.variant_calling_detail_metrics",
        summary_metrics = "{bucket}/wgs/{breed}/{sample_name}/{ref}/money/final_gather/{breed}_{sample_name}.variant_calling_summary_metrics",
    params:
...
rule bcftools_stats:
    input:
        final_vcf       = "{bucket}/wgs/{breed}/{sample_name}/{ref}/money/final_gather/{breed}_{sample_name}.{ref}.vcf.gz",
        final_vcf_index = "{bucket}/wgs/{breed}/{sample_name}/{ref}/money/final_gather/{breed}_{sample_name}.{ref}.vcf.gz.tbi"
    output:
        all_stats = "{bucket}/wgs/{breed}/{sample_name}/{ref}/money/final_gather/stats/{breed}_{sample_name}.{ref}.vchk",
    params:
...
rule bcftools_plot:
    input:
        all_stats = "{bucket}/wgs/{breed}/{sample_name}/{ref}/money/final_gather/stats/{breed}_{sample_name}.{ref}.vchk",
    output:
        summary = "{bucket}/wgs/{breed}/{sample_name}/{ref}/money/final_gather/stats/{breed}_{sample_name}/summary.pdf"
    params:

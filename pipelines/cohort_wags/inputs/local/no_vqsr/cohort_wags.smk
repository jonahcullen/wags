...
rule all:
    input:
        # vep'ed vcf
        expand(
           #"{bucket}/wgs/pipeline/{ref}/{date}/unfltr_vcf/all_vars.vcf.gz",
           #"{bucket}/wgs/pipeline/{ref}/{date}/final_gather/joint_call.{ref}.{date}.vcf.gz",
           #"{bucket}/wgs/pipeline/{ref}/{date}/final_gather/joint_call.{ref}.{date}.vep.vcf.gz",
           #"{bucket}/wgs/pipeline/{ref}/{date}/money/joint_money.{ref}.K9MM.tar.gz",
            "{bucket}/wgs/pipeline/{ref}/{date}/money/sadie_negative_joint_money.{ref}.{date}.K9MM.tar.gz",
...
include: "rules/gather_and_phylop_vep.smk"

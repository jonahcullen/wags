...
rule snps_var_recal:
    ...
    output:
        snps_recal    = S3.remote("{bucket}/wgs/pipeline/{ref}/{date}/var_recal/snps.recal"),
        snps_tranches = S3.remote("{bucket}/wgs/pipeline/{ref}/{date}/var_recal/snps.tranches"),
        snps_plot     = S3.remote("{bucket}/wgs/pipeline/{ref}/{date}/var_recal/snps.plot.R"),
        snps_plot_pdf = S3.remote("{bucket}/wgs/pipeline/{ref}/{date}/var_recal/snps.plot.R.pdf"),
        tranches_pdf  = S3.remote("{bucket}/wgs/pipeline/{ref}/{date}/var_recal/snps.tranches.pdf"),
    params:
